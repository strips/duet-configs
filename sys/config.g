...
M566 X900 Y700 Z24.00 E400          ; set maximum instantaneous speed changes (mm/min)
M203 X25000 Y25000 Z2500.00 E600.00        ; set maximum speeds (mm/min)
M201 X1600.00 Y1200.00 Z100.00 E1000.00          ; set accelerations (mm/s^2)
M204 P1000 T1500
M906 X800 Y900 Z800:800 E700 I30               ; set motor currents (mA) and motor idle factor in per cent
M84 S30                                        ; Set idle timeout
;M572 D0 S1 ; 0.8 nozzle, 0.6 layer height, petg
...
G31 P500 X-43 Y-8 Z2.591                          ; set Z probe trigger value, offset and trigger height
M557 X0:318 Y8:359 P6							; define mesh grid

; Heaters
M308 S0 P"bedtemp" Y"thermistor" T100000 B4092 ; configure sensor 0 as thermistor on pin bedtemp
M950 H0 C"bedheat" T0                          ; create bed heater output on bedheat and map it to sensor 0
M143 H0 S130                                   ; set temperature limit for heater 0 to 150C
M307 H0 B0 S1.00                               ; disable bang-bang mode for the bed heater and set PWM limit
M140 H0                                        ; map heated bed to heater 0
M308 S1 P"e0temp" Y"thermistor" T100000 B4092  ; configure sensor 1 as thermistor on pin e0temp
M950 H1 C"e0heat" T1                           ; create nozzle heater output on e0heat and map it to sensor 1
M143 H1 S330                                   ; set temperature limit for heater 1 to 275C
